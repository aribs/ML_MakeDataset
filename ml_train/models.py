...
class DlModels:
    ...
    def rnn_base(self, char_index):
        ...
        model.add(Embedding(200, self.embed_dim))
        model.add(LSTM(128))
    ...
    def cnn_base(self, char_index):
        ...
        model.add(
            Embedding(18, self.embed_dim, input_length=self.sequence_length))
    ...
    def ann_base(self, char_index):
        ...
        model.add(
            Embedding(200, self.embed_dim, input_length=self.sequence_length))
    ...
    def att_base(self, char_index):
        ...
        model.add(Embedding(200, self.embed_dim, input_length=self.sequence_length))
